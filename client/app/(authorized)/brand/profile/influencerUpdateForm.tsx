...
const steps = [
  ...
  },
  {
    id: "Step 4",
    name: "Complete",
    fields: ["bio", "consentAndAgreements"],
  },
];
              ...
              >
                <div className="space-y-4">
                  <input
                    ...
                    className={`${errors.firstName ? 'border-red-500 animate-shake' : 'border-custom-dark-desaturated-blue'} w-full p-3 rounded-md border bg-white/50 placeholder-gray-500 focus:outline-none`}
                  />
                  {errors.firstName && (
                  ...
                  <input
                    ...
                    className={`${errors.lastName ? 'border-red-500 animate-shake' : 'border-custom-dark-desaturated-blue'} w-full p-3 rounded-md border bg-white/50 placeholder-gray-500 focus:outline-none`}
                  />
                  {errors.lastName && (
                  ...
                  {/* <input
                    ...
                    className={`${errors.username ? 'border-red-500 animate-shake' : 'border-custom-dark-desaturated-blue'} w-full p-3 rounded-md border bg-white/50 placeholder-gray-500 focus:outline-none`}
                  />
                  {errors.username && (
                  ...
                  <input
                    ...
                    placeholder="Email"
                    type="email"
                    className={`${errors.email ? 'border-red-500 animate-shake' : 'border-custom-dark-desaturated-blue'} w-full p-3 rounded-md border bg-white/50 placeholder-gray-500 focus:outline-none`}
                  />
                  {errors.email && (
