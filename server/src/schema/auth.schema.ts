...
// Sub-schemas for Campaign Validation
const targetAudienceValidationSchema = z.object({
...
const geographicFocusValidationSchema = z.object({
  country: z.string().min(1, "Country is required"),
  city: z.string().optional(),
});

const collaborationPreferencesValidationSchema = z.object({
  hasWorkedWithInfluencers: z.boolean(),
  exclusiveCollaborations: z.boolean(),
//   type: z.enum(["Nano", "Micro", "Mid-Tier", "Macro", "Celebrity"]),
...
const trackingAndAnalyticsValidationSchema = z.object({
...
export const CampaignValidationSchema = z
  .object({
    ...
    targetAudience: targetAudienceValidationSchema,
    primaryGoals: z.string().min(1, { message: "Primary goal is required" }),
    geographicFocus: geographicFocusValidationSchema,
    collaborationPreferences: collaborationPreferencesValidationSchema,
    trackingAndAnalytics: trackingAndAnalyticsValidationSchema,
    status: z
